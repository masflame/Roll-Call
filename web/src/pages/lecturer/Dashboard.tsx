...
function MetricCard({ label, value, icon: Icon, hint, tone }: any) {
  const toneCls =
    ...
    return (
    <div className={cx("rounded-xl border p-4", toneCls)}>
                  ...
                  <div key={i} className="border p-4 bg-gray-100">
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        <div className="h-6 w-16 bg-gray-200 animate-pulse mb-2" />
                        <div className="h-3 w-32 bg-gray-200 animate-pulse" />
                      </div>
                      <div className="border border-stroke-subtle bg-white/50 p-2">
          ...
          >
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={it.id}
                  className="flex flex-col gap-3 border border-stroke-subtle bg-surface px-4 py-3 sm:flex-row sm:items-center sm:justify-between"
                >
              ...
              <div className="border border-dashed border-stroke-subtle bg-surfaceAlt px-4 py-3 text-sm text-text-muted">
          ...
          >
            <div className="space-y-3">
              {queuedSchedules.length === 0 ? (
                <div className="border border-stroke-subtle bg-surfaceAlt px-4 py-4 text-sm text-text-muted">
                ...
                queuedSchedules.slice(0, 6).map((s) => (
                  <div
                    key={s.id}
                    className="flex flex-col gap-3 rounded-xl border border-stroke-subtle bg-surface px-4 py-3 sm:flex-row sm:items-center sm:justify-between"
                  >
                    <div className="min-w-0">
              ...
              {recentSessions.length === 0 ? (
                ...
                recentSessions.map((s: any) => {
                  ...
                  return (
                    <div
                      key={s.id}
                      className="flex flex-col gap-2 rounded-xl border border-stroke-subtle bg-surface px-4 py-3 sm:flex-row sm:items-center sm:justify-between"
                    >
                      <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-2">
                          <div className="truncate text-sm font-semibold text-text-primary">
          ...
          >
            <div className="space-y-3">
              {mockInsights.map((ins) => (
                <div
                  key={ins.id}
                  className="rounded-xl border border-stroke-subtle bg-surface px-4 py-3"
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
        ...
        <div className="rounded-2xl border border-stroke-subtle bg-surface shadow-subtle">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 border-t border-stroke-subtle p-5">
            ...
            <div className="flex items-center gap-2">
              <Link
                to="/history"
                className="px-3 py-2 text-sm font-semibold text-brand-secondary transition hover:bg-brand-soft"
              >
                Attendance history
              </Link>
            </div>
        ...
        <aside className="space-y-6">
          <div className="rounded-2xl border border-stroke-subtle bg-surface shadow-subtle">
            ...
            <div className="p-2">
              <Link
                to="/analytics"
                className="flex items-start justify-between gap-3 p-4 transition hover:bg-surfaceAlt"
              >
